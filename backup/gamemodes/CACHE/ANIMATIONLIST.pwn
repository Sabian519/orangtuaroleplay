...
CMD:anime(playerid, params[])// 24/02/2014
{
    ...
    strcat(str, ""LG_E"/pee - /lean - /run - /poli - /surrender - /sit - /breathless - /seat - /rap - /cross - /pedmove - /jiggy - /gesture\n");
...
CMD:sit(playerid,params[])
{
	...
	switch(anim){
		...
		case 2: ApplyAnimation(playerid,"BEACH","Lay_Bac_Loop",4.1, 1, 1, 1, 1, 1, 1);
		case 3: ApplyAnimation(playerid,"BEACH","ParkSit_W_loop",4.1, 1, 1, 1, 1, 1, 1);
		case 4: ApplyAnimation(playerid,"BEACH","SitnWait_loop_W",4.1, 1, 1, 1, 1, 1, 1);
		case 5: ApplyAnimation(playerid,"BEACH","SitnWait_loop_W",4.1, 1, 1, 1, 1, 1, 1);
		case 6: ApplyAnimation(playerid,"BEACH", "ParkSit_M_loop", 4.1, 1, 1, 1, 1, 1, 1);
...
/*CMD:sleep(playerid,params[])
{
	...
	switch(anim){
		case 1: ApplyAnimation(playerid,"CRACK","crckdeth4",4.1, 1, 1, 1, 1, 1, 1);
		case 2: ApplyAnimation(playerid,"CRACK","crckidle2",4.1, 1, 1, 1, 1, 1, 1);
	}
	return 1;
}*/
...
CMD:cheer(playerid,params[])
{
	...
	switch(anim){
		case 1: ApplyAnimation(playerid,"ON_LOOKERS","shout_01",4.1, 1, 1, 1, 1, 1, 1);
		case 2: ApplyAnimation(playerid,"ON_LOOKERS","shout_02",4.1, 1, 1, 1, 1, 1, 1);
		case 3: ApplyAnimation(playerid,"ON_LOOKERS","shout_in",4.1, 1, 1, 1, 1, 1, 1);
		case 4: ApplyAnimation(playerid,"RIOT","RIOT_ANGRY_B",4.1, 1, 1, 1, 1, 1, 1);
		case 5: ApplyAnimation(playerid,"RIOT","RIOT_CHANT",4.1, 1, 1, 1, 1, 1, 1);
		case 6: ApplyAnimation(playerid,"RIOT","RIOT_shout",4.1, 1, 1, 1, 1, 1, 1);
		case 7: ApplyAnimation(playerid,"STRIP","PUN_HOLLER",4.1, 1, 1, 1, 1, 1, 1);
		case 8: ApplyAnimation(playerid,"OTB","wtchrace_win",4.1, 1, 1, 1, 1, 1, 1);
	}
	return 1;
}
...
CMD:dj(playerid,params[])
{
	...
	switch(anim){
		case 1: ApplyAnimation(playerid,"SCRATCHING","scdldlp",4.1, 1, 1, 1, 1, 1, 1);
		case 2: ApplyAnimation(playerid,"SCRATCHING","scdlulp",4.1, 1, 1, 1, 1, 1, 1);
		case 3: ApplyAnimation(playerid,"SCRATCHING","scdrdlp",4.1, 1, 1, 1, 1, 1, 1);
		case 4: ApplyAnimation(playerid,"SCRATCHING","scdrulp",4.1, 1, 1, 1, 1, 1, 1);
...
CMD:poli(playerid,params[])
{
	...
	switch(anim){
		case 1:ApplyAnimation(playerid,"POLICE","CopTraf_Come",4.1, 1, 1, 1, 1, 1, 1);
		case 2:ApplyAnimation(playerid,"POLICE","CopTraf_Stop",4.1, 1, 1, 1, 1, 1, 1);
...
CMD:seat(playerid,params[])
{
	...
	switch(anim){
		case 1: ApplyAnimation(playerid,"Attractors","Stepsit_in",4.1, 1, 1, 1, 1, 1, 1);// Not looping
		case 2: ApplyAnimation(playerid,"CRIB","PED_Console_Loop",4.1, 1, 1, 1, 1, 1, 1);
		case 3: ApplyAnimation(playerid,"INT_HOUSE","LOU_In",4.1, 1, 1, 1, 1, 1, 1); // Not looping
		case 4: ApplyAnimation(playerid,"MISC","SEAT_LR",4.1, 1, 1, 1, 1, 1, 1);
		case 5: ApplyAnimation(playerid,"MISC","Seat_talk_01",4.1, 1, 1, 1, 1, 1, 1);
		case 6: ApplyAnimation(playerid,"MISC","Seat_talk_02",4.1, 1, 1, 1, 1, 1, 1);
		case 7: ApplyAnimation(playerid,"ped","SEAT_down",4.1, 1, 1, 1, 1, 1, 1); // Not looping
	}
	return 1;
}
...
CMD:cross(playerid,params[])
{
	...
	switch(anim){
		case 1: ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_loop", 4.1, 1, 1, 1, 1, 1, 1);
		case 2: ApplyAnimation(playerid, "DEALER", "DEALER_IDLE", 4.1, 1, 1, 1, 1, 1, 1);
		case 3: ApplyAnimation(playerid, "DEALER", "DEALER_IDLE_01", 4.1, 1, 1, 1, 1, 1, 1);
		case 4: ApplyAnimation(playerid,"GRAVEYARD","mrnM_loop",4.1, 1, 1, 1, 1, 1, 1);
		case 5: ApplyAnimation(playerid,"GRAVEYARD","prst_loopa",4.1, 1, 1, 1, 1, 1, 1);
...
CMD:idles(playerid, params[])
{
	new anim;
	if(GetPlayerState(playerid) != PLAYER_STATE_ONFOOT || pData[playerid][pInjured] == 1) return Error(playerid, "You can't do at this moment.");
	if(sscanf(params, "d", anim)) return Usage(playerid,"/idles [1-15]");
	switch(anim)
	{
	case 1: ApplyAnimation(playerid, "PLAYIDLES", "shift", 4.1, 1, 1, 1, 1, 1);
	case 2: ApplyAnimation(playerid, "PLAYIDLES", "shldr", 4.1, 1, 1, 1, 1, 1);
	case 3: ApplyAnimation(playerid, "PLAYIDLES", "stretch", 4.1, 1, 1, 1, 1, 1);
	case 4: ApplyAnimation(playerid, "PLAYIDLES", "strleg", 4.1, 1, 1, 1, 1, 1);
	case 5: ApplyAnimation(playerid, "PLAYIDLES", "time", 4.1, 1, 1, 1, 1, 1);
	case 6: ApplyAnimation(playerid, "COP_AMBIENT", "Copbrowse_loop", 4.1, 1, 0, 0, 0, 0);
	case 7: ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_loop", 4.1, 1, 0, 0, 0, 0);
	case 8: ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_shake", 4.1, 1, 0, 0, 0, 0);
	case 9: ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_think", 4.1, 1, 0, 0, 0, 0);
	case 10: ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_watch", 4.1, 1, 0, 0, 0, 0);
	case 11: ApplyAnimation(playerid, "PED", "roadcross", 4.1, 1, 0, 0, 0, 0);
	case 12: ApplyAnimation(playerid, "PED", "roadcross_female", 4.1, 1, 0, 0, 0, 0);
	case 13: ApplyAnimation(playerid, "PED", "roadcross_gang", 4.1, 1, 0, 0, 0, 0);
	case 14: ApplyAnimation(playerid, "PED", "roadcross_old", 4.1, 1, 0, 0, 0, 0);
	case 15: ApplyAnimation(playerid, "PED", "woman_idlestance", 4.1, 1, 0, 0, 0, 0);
...
CMD:pedmove(playerid, params[])
{
	new anim;
	if(GetPlayerState(playerid) != PLAYER_STATE_ONFOOT || pData[playerid][pInjured] == 1) return Error(playerid, "You can't do at this moment.");
	if(sscanf(params, "d", anim)) return Usage(playerid,"/pedmove [1-26]");
	switch(anim)
	{
...
CMD:gesture(playerid,params[])
{
	...
	switch(gesture){
		case 1: ApplyAnimation(playerid,"GHANDS","gsign1",4.1, 1, 1, 1, 1, 1, 1);
		case 2: ApplyAnimation(playerid,"GHANDS","gsign1LH",4.1, 1, 1, 1, 1, 1, 1);
		case 3: ApplyAnimation(playerid,"GHANDS","gsign2",4.1, 1, 1, 1, 1, 1, 1);
		case 4: ApplyAnimation(playerid,"GHANDS","gsign2LH",4.1, 1, 1, 1, 1, 1, 1);
		case 5: ApplyAnimation(playerid,"GHANDS","gsign3",4.1, 1, 1, 1, 1, 1, 1);
		case 6: ApplyAnimation(playerid,"GHANDS","gsign3LH",4.1, 1, 1, 1, 1, 1, 1);
		case 7: ApplyAnimation(playerid,"GHANDS","gsign4",4.1, 1, 1, 1, 1, 1, 1);
		case 8: ApplyAnimation(playerid,"GHANDS","gsign4LH",4.1, 1, 1, 1, 1, 1, 1);
		case 9: ApplyAnimation(playerid,"GHANDS","gsign5",4.1, 1, 1, 1, 1, 1, 1);
		case 10: ApplyAnimation(playerid,"GHANDS","gsign5",4.1, 1, 1, 1, 1, 1, 1);
		case 11: ApplyAnimation(playerid,"GHANDS","gsign5LH",4.1, 1, 1, 1, 1, 1, 1);
		case 12: ApplyAnimation(playerid,"GANGS","Invite_No",4.1, 1, 1, 1, 1, 1, 1);
		case 13: ApplyAnimation(playerid,"GANGS","Invite_Yes",4.1, 1, 1, 1, 1, 1, 1);
		case 14: ApplyAnimation(playerid,"GANGS","prtial_gngtlkD",4.1, 1, 1, 1, 1, 1, 1);
		case 15: ApplyAnimation(playerid,"GANGS","smkcig_prtl",4.1, 1, 1, 1, 1, 1, 1);
...
CMD:smoke(playerid,params[])
{
	...
	switch(gesture){
		case 1: ApplyAnimation(playerid,"SMOKING","M_smk_in",4.1, 1, 1, 1, 1, 1, 1);
		case 2: ApplyAnimation(playerid,"SMOKING","M_smklean_loop",4.1, 1, 1, 1, 1, 1, 1);
		default: return Usage(playerid, "/smoke [1-2]");
	}
	return 1;
}
	
CMD:chora(playerid,params[]) { ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_watch",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:relax(playerid,params[]) { ApplyAnimation(playerid, "CRACK", "crckidle1",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:crabs(playerid,params[]) { ApplyAnimation(playerid,"MISC","Scratchballs_01",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:greeting(playerid,params[]) { ApplyAnimation(playerid,"ON_LOOKERS","Pointup_loop",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:stop(playerid,params[]) { ApplyAnimation(playerid,"PED","endchat_01",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:wash(playerid,params[]) { ApplyAnimation(playerid,"BD_FIRE","wash_up",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:mourn(playerid,params[]) { ApplyAnimation(playerid,"GRAVEYARD","mrnF_loop",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:followme(playerid,params[]) { ApplyAnimation(playerid,"WUZI","Wuzi_follow",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:still(playerid,params[]) { ApplyAnimation(playerid,"WUZI","Wuzi_stand_loop", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:hitch(playerid,params[]) { ApplyAnimation(playerid,"MISC","Hiker_Pose", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:palmbitch(playerid,params[]) { ApplyAnimation(playerid,"MISC","bitchslap",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:cpranim(playerid,params[]) { ApplyAnimation(playerid,"MEDIC","CPR",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:giftgiving(playerid,params[]) { ApplyAnimation(playerid,"KISSING","gift_give",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:slap2(playerid,params[]) { ApplyAnimation(playerid,"SWEET","sweet_ass_slap",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:drunk(playerid,params[]) { ApplyAnimation(playerid,"PED","WALK_DRUNK",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:pump(playerid,params[]) { ApplyAnimation(playerid, "BOMBER", "BOM_Plant", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:tosteal(playerid,params[]) { ApplyAnimation(playerid,"ped", "ARRESTgun", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:laugh(playerid,params[]) { ApplyAnimation(playerid, "RAPPING", "Laugh_01", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:lookout(playerid,params[])  { ApplyAnimation(playerid, "SHOP", "ROB_Shifty", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:robman(playerid,params[]) { ApplyAnimation(playerid, "SHOP", "ROB_Loop_Threat", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:hide(playerid,params[]) { ApplyAnimation(playerid, "ped", "cower",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:vomit(playerid,params[]) { ApplyAnimation(playerid, "FOOD", "EAT_Vomit_P", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:eat(playerid,params[]) { ApplyAnimation(playerid, "FOOD", "EAT_Burger", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:crack(playerid,params[]) { ApplyAnimation(playerid, "CRACK", "crckdeth2", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:fuck(playerid,params[]) { ApplyAnimation(playerid,"PED","fucku",4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:taichi(playerid,params[]) { ApplyAnimation(playerid,"PARK","Tai_Chi_Loop", 4.1, 1, 1, 1, 1, 1, 1); return 1; }
CMD:entrenar(playerid,params[]) { ApplyAnimation(playerid,"PARK","Tai_Chi_Loop", 4.1, 1, 1, 1, 1, 1, 1); return 1; } // amin para magos
CMD:kiss(playerid,params[]) { ApplyAnimation(playerid,"KISSING","Playa_Kiss_01",4.1, 1, 1, 1, 1, 1, 1); return 1; }
...
{
	ApplyAnimation(playerid,"ped", "ARRESTgun", 4.1, 1, 1, 1, 1, 1, 1); // Gun Arrest
	return 1;
}
CMD:crossarms(playerid, params[])//28
{
	ApplyAnimation(playerid, "COP_AMBIENT", "Coplook_loop", 4.1, 1, 1, 1, 1, 1, 1); // Arms crossed
	return 1;
}

CMD:lay(playerid, params[])//29
{
	ApplyAnimation(playerid,"BEACH", "bather",4.1, 1, 1, 1, 1, 1, 1); // Lay down
	return 1;
}

CMD:foodeat(playerid, params[])//32
{
	ApplyAnimation(playerid, "FOOD", "EAT_Burger", 4.1, 1, 1, 1, 1, 1, 1); // Eat Burger
	return 1;
}
...
{
	ApplyAnimation(playerid, "SWEET", "sweet_ass_slap", 4.1, 1, 1, 1, 1, 1, 1); // Ass Slapping
 	return 1;
}

CMD:dealer(playerid, params[])//35
{
	ApplyAnimation(playerid, "DEALER", "DEALER_DEAL", 4.1, 1, 1, 1, 1, 1, 1); // Deal Drugs
	return 1;
}

CMD:groundsit(playerid, params[])//38
{
	ApplyAnimation(playerid,"BEACH", "ParkSit_M_loop", 4.1, 1, 1, 1, 1, 1, 1); // Sit
	return 1;
}
...
CMD:chat(playerid, params[])//39
{
	...
	if(num == 2) { ApplyAnimation(playerid,"MISC","Idle_Chat_02",4.1, 1, 1, 1, 1, 1, 1); }
    return 1;
}
...
CMD:sup(playerid, params[])//47
{
	...
	if(number == 1) { ApplyAnimation(playerid,"GANGS","hndshkba",4.1, 1, 1, 1, 1, 1, 1); }
	if(number == 2) { ApplyAnimation(playerid,"GANGS","hndshkda",4.1, 1, 1, 1, 1, 1, 1); }
    if(number == 3) { ApplyAnimation(playerid,"GANGS","hndshkfa_swt",4.1, 1, 1, 1, 1, 1, 1); }
   	return 1;
}
...
CMD:basket(playerid, params[])//87
{
    ...
    switch(ddr)
	{
		...
		case 3: { ApplyAnimation(playerid,"BSKTBALL","BBALL_pickup",4.1, 1, 1, 1, 1, 1, 1); }
		...
		case 6: { ApplyAnimation(playerid,"BSKTBALL","BBALL_Dnk",4.1, 1, 1, 1, 1, 1, 1); }
	}
   	return 1;
}
...
CMD:gwalk(playerid, params[])//89
{
	...
	if (ssr == 1) { ApplyAnimation(playerid,"PED","WALK_gang1",4.1, 1, 1, 1, 1, 1, 1); }
 	if (ssr == 2) { ApplyAnimation(playerid,"PED","WALK_gang2",4.1, 1, 1, 1, 1, 1, 1); }
   	return 1;
}
...
CMD:aim(playerid, params[])//90
{
	...
	if(lmb == 1) { ApplyAnimation(playerid,"PED","gang_gunstand",4.1, 1, 1, 1, 1, 1, 1); }
    if(lmb == 2) { ApplyAnimation(playerid,"PED","Driveby_L",4.1, 1, 1, 1, 1, 1, 1); }
    if(lmb == 3) { ApplyAnimation(playerid,"PED","Driveby_R",4.1, 1, 1, 1, 1, 1, 1); }
...
CMD:lean(playerid, params[])//91
{
    ...
    if(mj == 1) { ApplyAnimation(playerid,"GANGS","leanIDLE",4.1, 1, 1, 1, 1, 1, 1); }
	if(mj == 2) { ApplyAnimation(playerid,"MISC","Plyrlean_loop",4.1, 1, 1, 1, 1, 1, 1); }
   	return 1;
}
...
CMD:sexy(playerid, params[])
{
	...
	if(strcmp(choice, "1", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKING_IDLEW",4.1, 1, 1, 1, 1, 1, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "2", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKING_IDLEP",4.1, 1, 1, 1, 1, 1, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "3", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKINGW",4.1, 1, 1, 1, 1, 1, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "4", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKINGP",4.1, 1, 1, 1, 1, 1, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "5", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKEDW",4.1, 1, 1, 1, 1, 1, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "6", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKEDP",4.1, 1, 1, 1, 1, 1, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "7", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKING_ENDW",4.1, 1, 1, 1, 1, 1, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	if(strcmp(choice, "8", true) == 0)
	{
		ApplyAnimation(playerid,"SNM","SPANKING_ENDP",4.1, 1, 1, 1, 1, 1, 1);
		SetPVarInt(playerid, "UsingAnim", 1);
	}
	return 1;
}
