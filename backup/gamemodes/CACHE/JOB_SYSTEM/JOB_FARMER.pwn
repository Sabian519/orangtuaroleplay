...
CMD:farm(playerid, params[])
{
	...
	if(!strcmp(params, "plant", true))
	{
		if(pData[playerid][pJob] == 7 || pData[playerid][pJob2] == 7)
		{
			...
			format(String, sizeof(String), ""YELLOW_E"Potato\t"GREEN_E"5 Seed\n");
			strcat(S3MP4K, String);
			format(String, sizeof(String), ""LIME_E"Wheat\t"GREEN_E"18 Seed\n");
			strcat(S3MP4K, String);
			format(String, sizeof(String), ""ORANGE_E"Orange\t"GREEN_E"11 Seed\n");
			strcat(S3MP4K, String);
			format(String, sizeof(String), ""RED_E"[ILEGAL]Marijuana\t"GREEN_E"50 Seed\n");
			strcat(S3MP4K, String);
