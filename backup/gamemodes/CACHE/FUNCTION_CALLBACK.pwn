...
function CheckVerify(playerid)
{
    ...
    {
        format(strong, sizeof strong, "Dear: "LG_E2"%s\n\n"YELLOW_E"Checking Account Warning.\n"WHITE_E"There is account "BLUESKY"%s's "WHITE_E"doest not verified\n"WHITE_E"Please Registered UCP on Discord or Contact Moderator Servers\n"WHITE_E"- "YELLOW_E"https://discord.io//RanumRoleplay\n\n"PINK_E"copyrigh(c) by RanumRoleplay Team", pData[playerid][pName], pData[playerid][pName]);
		ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "RANUM:RP - UCP Protection", strong, "Close", "");
...
function SafeLogin(playerid)
{
    ...
    {
        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, "Invalid Roleplay Names", "Nama tidak sesuai format untuk server mode roleplay.\nPenggunaan nama harus mengikuti format Firstname_Lastname.\n\nSebagai contoh, Steven_Dreschler, Nick_Raymond, dll.", "F.Q.A", "Quit");
        SendClientMessageToAllEx(playerid, ""RED_E"BotCmd: "GREY2_E"Nama Character kamu Invalid Roleplay Name"RED_E"(Kicked)");
