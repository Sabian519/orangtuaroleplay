/*
	Copyright © 2021 OrangTua Roleplay

			  BASED OF GAMEMODE: LRP v10


	[================== THANKS TO ==================]
	[ + God   + Parents   + Dandy for Base script   ]
	[ + Pateer ( for gamemode LRP V10 )          ]
	[ + LunarPride RP Staff's                      ]
	[===============================================]
...
*Changelogs Mode v1.0.13.
============================
+ [ADD] Gym Business
+ [FIXED] SAPD Vehicle doing Bugged
+ [FIXED] SAPD Garages

*Changelogs Mode v1.0.14
============================
+ [ADD] Script Discord Bot
+ [FIXED] Fixed Bot Not SYNC Main Script
+ [FIXED] FIxed Server Crash During Playing Inggame
+ [ADD] Detect Player Cheat Ingame
+ [ADD] Modshop for Vehicle
+ [REWORK] Reseting All Database

*Changelogs Mode v1.0.16
============================
+ [ADD] Pizza Job System
+ [ADD] Door Moved to San fierro
+ [FIXED] Streamer bugged

[TO DO LIST]
- Pindahin Semua job ke SF
- Hapusin mapping di ls karna gaguna
- Fitur sealed buat government
...
new DCC_Channel:serverinformation;
new DCC_Channel:ucpdc;
new DCC_Channel:verifydc;
...
function AutoGmx()
{
	...
	DCC_SendChannelMessage(serverinformation, "Server akan otomatis __Restar__ Dalam 60 detik.");
	return 1;
}
function GmxNya()
{
...
public OnGameModeInit()
{
	...
	print("=======================================================");
 	print("                      			             	     ");
 	print("        	  OrangTua Roleplay V.3.0.6 WIKWOK.           ");
 	print("            • Scripters Gamemode Sabian •		  	   ");
 	print("                                  				     ");
 	print("=======================================================");
	//****************************//
	CreateTextDraw();
	...
	CreateDynamicPickup(1239, 23, 1375.7867, -21.3897, 1000.8729, -1);
	format(strings, sizeof(strings), ""X1_BLUE"[REKENING BANK]\n/newrek - create new rekening");
	CreateDynamic3DTextLabel(strings, COLOR_YELLOW, 1375.7867, -21.3897, 1000.8729, 3.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); // bank
	...
	// STARTERPACK
	CreateDynamicPickup(1239, 23, -1420.4442,-291.3445,14.1484, -1);
	format(strings, sizeof(strings), "Startpack Point\n"WHITE_E"use '"YELLOW_E"/claimsp"WHITE_E"' to claimed starterpack");
	CreateDynamic3DTextLabel(strings, ARWIN, -1420.4442,-291.3445,14.1484, 5.0); //  Starterpack

	//SELL CRATE FISH
	CreateDynamicPickup(1239, 23, -1714.2910,-62.6902,3.5547, -1);
	format(strings, sizeof(strings), ""LG_E"[GUDANG IKAN]\n"YELLOW_E"/sellcrate");
	CreateDynamic3DTextLabel(strings, COLOR_YELLOW, -1714.2910,-62.6902,3.5547, 3.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); // bank
	...
	//SAPDCAR
	SAPDVehicles[0] = AddStaticVehicleEx(597,-1574.2963,706.1106,-5.4737,91.5715,0,1, VEHICLE_RESPAWN, 1); // Cruiser
	SAPDVehicles[1] = AddStaticVehicleEx(597,-1574.4093,710.1951,-5.4727,88.7401,0,1, VEHICLE_RESPAWN, 1); // Cruiser
	SAPDVehicles[2] = AddStaticVehicleEx(597,-1574.3281,714.1893,-5.4760,90.4207,0,1, VEHICLE_RESPAWN, 1); // Cruiser
	SAPDVehicles[3] = AddStaticVehicleEx(597,-1574.3812,718.2313,-5.4720,91.2020,0,1, VEHICLE_RESPAWN, 1); // Cruiser
	SAPDVehicles[4] = AddStaticVehicleEx(597,-1574.3193,722.3340,-5.4745,91.7141,0,1, VEHICLE_RESPAWN, 1); // Cruiser
	SAPDVehicles[5] = AddStaticVehicleEx(597,-1574.2808,726.4319,-5.4688,88.8905,0,1, VEHICLE_RESPAWN, 1); // Cruiser
	SAPDVehicles[6] = AddStaticVehicleEx(407,-1574.2485,738.5728,-5.0078,91.2189,0,1, VEHICLE_RESPAWN, 1); // Cruiser
	SAPDVehicles[7] = AddStaticVehicleEx(544,-1573.6614,742.7102,-5.0069,90.1080,0,1, VEHICLE_RESPAWN, 1); // Cruiser
	SAPDVehicles[8] = AddStaticVehicleEx(597,-1574.3792,730.4561,-5.4645,91.6784,0,1, VEHICLE_RESPAWN, 1); // Cruiser
	SAPDVehicles[9] = AddStaticVehicleEx(597,-1574.4403,734.6821,-5.4736,89.3432,0,1, VEHICLE_RESPAWN, 1); // Cruiser
	SAPDVehicles[10] = AddStaticVehicleEx(599,-1583.9833,749.1940,-5.0544,178.5160,0,1, VEHICLE_RESPAWN, 1); // Rancher
	SAPDVehicles[11] = AddStaticVehicleEx(599,-1579.9506,749.3123,-5.0402,179.7510,0,1, VEHICLE_RESPAWN, 1); // Rancher
	SAPDVehicles[12] = AddStaticVehicleEx(601,-1600.2378,676.6727,-5.4834,357.2982,1,1, VEHICLE_RESPAWN, 1); // Splashy
	SAPDVehicles[13] = AddStaticVehicleEx(601,-1596.1301,676.7668,-5.4820,0.7453,1,1, VEHICLE_RESPAWN, 1); // Splashy
	...
	SAPDVehicles[14] = AddStaticVehicleEx(528,-1588.2034,708.8133,-5.1935,270.5805,0,0, VEHICLE_RESPAWN, 1); // SWAT Van
	SAPDVehicles[15] = AddStaticVehicleEx(560,-1599.7341,672.2657,6.8923,178.6654,0,0, VEHICLE_RESPAWN, 1); // Sultan
	SAPDVehicles[16] = AddStaticVehicleEx(560,-1593.9640,672.4575,6.8929,180.8057,0,0, VEHICLE_RESPAWN, 1); // Sultan
	SAPDVehicles[17] = AddStaticVehicleEx(523,-1605.6890,735.4940,-5.6641,1.45520,0,0, VEHICLE_RESPAWN, 1); // Police Bike
	SAPDVehicles[18] = AddStaticVehicleEx(523,-1607.6360,735.6891,-5.6679,358.1287,0,0, VEHICLE_RESPAWN, 1); // Police Bike
	SAPDVehicles[19] = AddStaticVehicleEx(523,-1609.3762,735.7557,-5.6680,358.9479,0,0, VEHICLE_RESPAWN, 1); // Police Bike
	SAPDVehicles[20] = AddStaticVehicleEx(597,-1628.8506,652.1835,6.8856,359.7454,0,1, VEHICLE_RESPAWN, 1); // Cruiser (Front)
	SAPDVehicles[21] = AddStaticVehicleEx(597,-1634.4983,652.0900,6.9576,0.6604,0,1, VEHICLE_RESPAWN, 1); // Cruiser (Front)
	SAPDVehicles[22] = AddStaticVehicleEx(525,-1612.4601,734.3924,-5.3598,359.3224,17,20, VEHICLE_RESPAWN, 1); // Tow Truck
	SAPDVehicles[23] = AddStaticVehicleEx(525,-1616.5768,734.2061,-5.3619,359.8047,18,20, VEHICLE_RESPAWN, 1); // Tow Truck
	SAPDVehicles[24] = AddStaticVehicleEx(497,-1650.9956,698.1562,38.4213,8.7635,0,1, VEHICLE_RESPAWN, 1); // Maverick
	SAPDVehicles[25] = AddStaticVehicleEx(497,-1680.0906,705.7595,30.7829,93.9908,0,1, VEHICLE_RESPAWN, 1); // Maverick
 	SAPDVehicles[26] = AddStaticVehicleEx(411,-1606.1130,672.2749,6.9146,180.9274,0,1, VEHICLE_RESPAWN, 1); // Infernus
	SAPDVehicles[27] = AddStaticVehicleEx(411,-1611.6029,672.1602,6.9146,180.3459,0,1, VEHICLE_RESPAWN, 1); // Infernus
	...
	//SAMDCAR
	SAMDVehicles[0] = AddStaticVehicleEx(407, -2546.1345,633.8060,28.0462,90.5216, -1, 3, VEHICLE_RESPAWN, 1);
	SAMDVehicles[1] = AddStaticVehicleEx(407, -2546.0471,639.2508,28.0471,90.0039, -1, 3, VEHICLE_RESPAWN, 1);
	SAMDVehicles[2] = AddStaticVehicleEx(544, -2546.4404,644.0839,28.0460,90.6355, -1, 3, VEHICLE_RESPAWN, 1);
	SAMDVehicles[3] = AddStaticVehicleEx(416, -2591.5051,666.0633,27.9626,269.7253, 1, 3, VEHICLE_RESPAWN, 1);
	SAMDVehicles[4] = AddStaticVehicleEx(416, -2591.4236,661.2012,27.9616,269.8588, 1, 3, VEHICLE_RESPAWN, 1);
	SAMDVehicles[5] = AddStaticVehicleEx(416, -2639.3899,634.4218,14.6029,179.1232, 1, 3, VEHICLE_RESPAWN, 1);
	SAMDVehicles[6] = AddStaticVehicleEx(442, -2583.6741,626.3971,27.6373,0.0938, 0, 1, VEHICLE_RESPAWN, 1);
	SAMDVehicles[7] = AddStaticVehicleEx(426, -2578.7813,626.7448,27.5558,359.2744, 0, 1, VEHICLE_RESPAWN, 1);
	SAMDVehicles[8] = AddStaticVehicleEx(416, -2694.1035,624.0894,14.6024,129.0543, 1, 3, VEHICLE_RESPAWN, 1);
	SAMDVehicles[9] = AddStaticVehicleEx(586, -2573.4866,626.8304,27.3260,1.1316, 0, 1, VEHICLE_RESPAWN, 1);
	SAMDVehicles[10] = AddStaticVehicleEx(563, -2637.6636,531.1888,50.5637,271.6573, -1, 3, VEHICLE_RESPAWN, 1);
	SAMDVehicles[11] = AddStaticVehicleEx(487, -2661.4121,530.7549,50.5857,88.8176, -1, 3, VEHICLE_RESPAWN, 1);
	...
	// Discord Server
	ucp = DCC_FindChannelById("786899478665494582");
	login = DCC_FindChannelById("maintance");
	logout = DCC_FindChannelById("maintance");
	inchanel = DCC_FindChannelById("930461322376802316");
	serverinformation = DCC_FindChannelById("835257439972622386");
	serverguild = DCC_FindGuildById("786899478027960390");
	ucpdc = DCC_FindChannelById("786899478665494582");// ini id channel buat register UCP
	verifydc = DCC_FindChannelById("930461550857306112");
	...
	DCC_SendChannelMessage(serverinformation, "Server Is Back Online , Happy Roleplaying.");
	return 1;
}
...
public OnGameModeExit()
{
	...
	DCC_SendChannelMessage(serverinformation, "Server Has__Shutdown__From RDP/VPS");
...
new const RandomMessage[5][144] = {
    ...
    ""X1_BLUE"MOTD: "WHITE_E"If you want to get complete server information, come join our discord: "AQUA"discord.gg/otrp"
};
...
public OnPlayerConnect(playerid)
{
	...
	pData[playerid][FOODPROGRESS] = CreatePlayerProgressBar(playerid, 580.000000, 417.500000, 48.000000, 5.000000, -21557249, 100.000000, 0);
	pData[playerid][DRINKPROGRESS] = CreatePlayerProgressBar(playerid, 580.000000, 434.500000, 48.000000, 5.000000, -21557249, 100.000000, 0);
//	pData[playerid][bladdybar] = CreatePlayerProgressBar(playerid, 565.500000, 435.000091, 68.000000, 8.000000, 16711935, 100.0, 0);

	//HBE textdraw Simple
	pData[playerid][BarFuel] = CreatePlayerProgressBar(playerid, 605.000000, 419.000000, 37.000000, 4.000000, 9109759, 1000.0, 0);
	pData[playerid][BarDamage] = CreatePlayerProgressBar(playerid, 605.000000, 405.000000, 37.000000, 4.000000, 9109759, 1000.0, 0);
	
	pData[playerid][BarLapar] = CreatePlayerProgressBar(playerid, 605.000000, 373.000000, 37.000000, 4.000000, 9109759, 100.0, 0); // 0 Warna
	pData[playerid][BarHaus] = CreatePlayerProgressBar(playerid, 605.000000, 389.000000, 37.000000, 4.000000, 9109759, 100.0, 0);
...
public OnPlayerEnterDynamicCP(playerid, checkpointid)
{
	...
	if(checkpointid == ShowRoomCPRent)
	{
		...
		format(String, sizeof(String), ""YELLOW_E"%s\t"LG_E"$5,00\t"RED_E"24 Hours'e\n", GetVehicleModelName(414));
...
public OnPlayerEnterRaceCheckpoint(playerid)
{
		...
		if(GetVehicleModel(vehicleid) == 574)
		{
			for(new i; i <= 3; i++) // 3 = Total Dialog , Jadi kita mau tau kalau Player Ini Apakah Ambil Dialog dari 3 tersebut apa ga !
			{
				if(SweeperSteps[playerid][i] > 0)
				{
				 	if(IsPlayerInAnyVehicle(playerid))
					{
						if(SweeperSteps[playerid][0] == 0)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 144);
					        AddPlayerSalary(playerid, "Street Cleanner(bonus)", 34);
					        SweeperSteps[playerid][0] = 2;
					        SetPlayerRaceCheckpoint(playerid, 0, -2071.8687,-98.5001,34.8951,-2162.1267,-74.2885,34.9013, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][0] == 1)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 15);
					        SweeperSteps[playerid][0] = 3;
					        SetPlayerRaceCheckpoint(playerid, 0, -2162.1267,-74.2885,34.9013,-2181.2678,-181.8522,34.9048, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][0] == 2)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2181.2678,-181.8522,34.9048,-2316.7605,-187.6639,34.8970, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][0] == 3)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2316.7605,-187.6639,34.8970,-2369.1240,-111.7349,34.8970, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][0] == 4)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2369.1240,-111.7349,34.8970,-2368.8486,22.2919,34.8969, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][0] == 5)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2368.8486,22.2919,34.8969,-2261.1799,45.5704,34.9008, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][0] == 6)
					    {
					        ...
					        AddPlayerSalary(playerid, "Street Cleanner(bonus)", 50);
					        SweeperSteps[playerid][0] = 8;
					        SetPlayerRaceCheckpoint(playerid, 0, -2261.1799,45.5704,34.9008,-2254.5933,-69.3082,34.8970, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][0] == 7)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2254.5933,-69.3082,34.8970,-2127.9189,-72.6103,34.9048, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][0] == 8)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2127.9189,-72.6103,34.9048,-2071.8687,-98.5001,34.8951, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][0] == 9)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 1, -2071.8687,-98.5001,34.8951,-2071.8687,-98.5001,34.8951, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][0] == 10)
					    {
							...
							AddPlayerSalary(playerid, "Street Cleanner(Idlewood)", 150);
					    ...
					    else if(SweeperSteps[playerid][1] == 11)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 1, -2071.8687,-97.5001,34.8951, -2071.8687,-97.5001,34.8951, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][1] == 12)
					    {
							...
							SCM(playerid, ARWIN, "SIDEJOBINFO: {FFFFFF}You have "LG_E"succesfully "WHITE_E"complete street cleanner route, and your payment in '"YELLOW_E"/mysalary"WHITE_E"'.");
							AddPlayerSalary(playerid, "Street Cleanner(Pershing Square)", 250);
		     				pData[playerid][pSideJobTime] = 1700;
			        		DisablePlayerRaceCheckpoint(playerid);
							RemovePlayerFromVehicle(playerid);
							SetTimerEx("RespawnPV", 3000, false, "d", vehicleid);
					    ...
					    else if(SweeperSteps[playerid][2] == 3)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 15);
					        AddPlayerSalary(playerid, "Street Cleanner(bonus)", 13);
					    ...
					    else if(SweeperSteps[playerid][2] == 13)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        AddPlayerSalary(playerid, "Street Cleanner(bonus)", 15);
					    ...
					    else if(SweeperSteps[playerid][2] == 15)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 1, -2071.8687,-96.5001,34.8951,-2071.8687,-96.5001,34.8951, 5);
					        return 1;
					    }
					    else if(SweeperSteps[playerid][2] == 16)
					    {
							...
							SCM(playerid, ARWIN, "SIDEJOBINFO: {FFFFFF}You have "LG_E"succesfully "WHITE_E"complete street cleanner route, and your payment in '"YELLOW_E"/mysalary"WHITE_E"'.");
							AddPlayerSalary(playerid, "Street Cleanner(Marina Beach)", 350);
		     				pData[playerid][pSideJobTime] = 1700;
			        		DisablePlayerRaceCheckpoint(playerid);
							RemovePlayerFromVehicle(playerid);
							SetTimerEx("RespawnPV", 3000, false, "d", vehicleid);
				...
				if(BusSteps[playerid][i] > 0)
				{
				 	if(IsPlayerInAnyVehicle(playerid))
					{
					    if(BusSteps[playerid][0] == 2)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2495.6030,-616.2666,132.6959, 1325.0560,-1569.7898,13.4628, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 3)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2426.2258,-607.3362,132.6956,1359.4424,-1422.9174,13.4767, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 4)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2457.7654,-514.0605,110.8733,1338.3066,-1394.7805,13.4779, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 5)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 70);
				        	AddPlayerSalary(playerid, "Bus Driver(bonus)", 15);
					        BusSteps[playerid][0] = 6;
					        SetPlayerRaceCheckpoint(playerid, 0, -2568.6335,-488.5405,77.5817,651.5914,-1393.6437,13.5422, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 6)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2581.8850,-471.8486,68.1346,539.4284,-1405.4429,15.7669, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 7)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2427.5181,-420.0118,85.8339,492.0627,-1309.9187,15.7158, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 8)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2319.8833,-436.7167,79.6875,153.1991,-1545.3175,10.5614, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 9)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2444.5757,-366.3953,70.3414,373.0657,-1720.0210,7.2636, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 10)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2600.8599,-370.2852,44.0528,1017.2707,-2218.5603,13.0459, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 11)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2679.5007,-449.5401,29.5030, 1017.2707,-2218.5603,13.0459, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 12)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2772.3198,-493.9222,7.3093,1312.3700,-2467.7739,7.7606, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 13)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2816.9255,-505.5236,7.1726,1443.5225,-2683.4890,13.4660, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 14)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2863.6682,-605.3973,7.1783,2167.0093,-2614.6147,13.4766, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 15)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2878.0203,-760.3283,7.1724,2297.5007,-2281.6836,13.4911, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 16)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2887.1299,-970.2168,9.6228,2245.5674,-2207.3191,13.4066, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 17)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2935.1008,-1276.2289,10.9547,1978.5647,-2107.1409,13.4477, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 18)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2940.9355,-1542.8357,11.0578,1964.9993,-1764.2311,13.4818, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 19)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2924.7417,-1824.3483,28.9233,1835.2019,-1750.1224,13.4855, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 20)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2760.6406,-2030.4475,37.8380,1824.7201,-1625.2925,13.4876, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 21)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2566.5879,-2162.2219,30.3022,1668.9048,-1590.1837,13.4715, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 22)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2562.1785,-2236.2844,26.6879,1662.6278,-1552.6962,13.4833, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 23)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2542.3450,-2306.5334,15.2107,1686.7153,-1551.0281,13.4776, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 24)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
				        	AddPlayerSalary(playerid, "Bus Driver(bonus)", 20);
					        BusSteps[playerid][0] = 25;
					        SetPlayerRaceCheckpoint(playerid, 0, -2401.7590,-2280.8774,14.8545,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 25)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 26;
					        SetPlayerRaceCheckpoint(playerid, 0, -2125.9722,-2112.8611,59.0978,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 26)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 27;
					        SetPlayerRaceCheckpoint(playerid, 0, -2048.1902,-1947.7625,54.1221,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 27)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 28;
					        SetPlayerRaceCheckpoint(playerid, 0, -1924.8181,-1794.1136,31.2550,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 28)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 29;
					        SetPlayerRaceCheckpoint(playerid, 0, -1754.1727,-1678.8376,35.5916,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 29)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 30;
					        SetPlayerRaceCheckpoint(playerid, 0, -1572.5023,-1608.3900,37.3627,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 30)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 31;
					        SetPlayerRaceCheckpoint(playerid, 0, -1542.3546,-1563.3973,37.8677,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 31)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 32;
					        SetPlayerRaceCheckpoint(playerid, 0, -1641.0891,-1502.6584,36.6502,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 32)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 33;
					        SetPlayerRaceCheckpoint(playerid, 0, -1789.4537,-1438.8192,35.4692,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 33)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
				        	AddPlayerSalary(playerid, "Bus Driver(bonus)", 20);
					        BusSteps[playerid][0] = 34;
					        SetPlayerRaceCheckpoint(playerid, 0, -1941.6249,-1350.8378,41.0001,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 34)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 35;
					        SetPlayerRaceCheckpoint(playerid, 0, 1686.7153,-1551.0281,13.4776,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 35)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 36;
					        SetPlayerRaceCheckpoint(playerid, 0, -2025.1552,-1237.9463,34.9722,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 36)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 37;
					        SetPlayerRaceCheckpoint(playerid, 0, -2090.7092,-1123.5270,30.5747,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 37)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 38;
					        SetPlayerRaceCheckpoint(playerid, 0, -2197.0420,-991.5510,36.5207,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 38)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 39;
					        SetPlayerRaceCheckpoint(playerid, 0, -2209.7710,-885.6329,50.9031,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 39)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 40;
					        SetPlayerRaceCheckpoint(playerid, 0, -2190.3115,-791.6659,61.0539,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 40)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 41;
					        SetPlayerRaceCheckpoint(playerid, 0, -2238.8667,-746.0263,67.5930,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 41)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
				        	AddPlayerSalary(playerid, "Bus Driver(bonus)", 20);
					        BusSteps[playerid][0] = 42;
					        SetPlayerRaceCheckpoint(playerid, 0, -2318.9016,-782.0150,91.5632,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 42)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 43;
					        SetPlayerRaceCheckpoint(playerid, 0, -2355.8079,-745.8420,99.4483,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 43)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 44;
					        SetPlayerRaceCheckpoint(playerid, 0, -2358.2444,-658.2842,121.4010,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 44)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 45;
					        SetPlayerRaceCheckpoint(playerid, 0, -2421.4248,-611.1674,132.6944,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 45)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
					        BusSteps[playerid][0] = 46;
					        SetPlayerRaceCheckpoint(playerid, 0, -2465.6018,-615.9283,132.6850,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 46)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 100);
				        	AddPlayerSalary(playerid, "Bus Driver(bonus)", 20);
					        BusSteps[playerid][0] = 47;
					        SetPlayerRaceCheckpoint(playerid, 1, -2496.3406,-613.2366,132.6975,1673.5162,-1477.9034,13.4807, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][0] == 47)
					    {
							...
							AddPlayerSalary(playerid, "Bus Drivers(Angel Pine)", 750);
					    ...
					    else if(BusSteps[playerid][1] == 6)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2493.5525,-617.8069,132.6950,1675.6584,-1594.5546,13.4830, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 7)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2433.9014,-618.1186,132.6917,1808.3151,-1614.4534,13.4606, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 8)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2405.4380,-631.2988,132.0836,1822.1866,-1602.4225,13.4650, 5);
					        return 1;
					    }
					    ...
					    else if(BusSteps[playerid][1] == 10)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2368.4043,-656.1677,123.8304,1976.1843,-1468.7709,13.4898, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 11)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2348.8672,-713.5499,109.2221, 1988.9058,-1453.9619,13.4881, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 12)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2354.6091,-778.0341,95.3151,1989.5841,-1354.7592,23.8970, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 13)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2310.4468,-783.4703,90.7212,2055.3843,-1343.6346,23.9209, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 14)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2236.5503,-750.3912,67.1750,2073.3601,-1237.0232,23.9111, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 15)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2196.9189,-796.0518,60.8303,2074.4985,-1106.5936,24.7291, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 16)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2218.5127,-901.1547,48.0624,1995.6899,-1054.9963,24.5139, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 17)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2202.0049,-996.6702,36.4886,1867.9518,-1058.5884,23.7857, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 18)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2099.8723,-1119.2888,30.4592,1863.6049,-1169.5271,23.7625, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 19)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -2009.2073,-1276.9095,36.8851,1657.9583,-1157.8536,23.8513, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 20)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1914.4685,-1370.6548,40.3363,1592.6194,-1159.1958,24.0051, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 21)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1900.0017,-1297.0990,39.6332,1549.6796,-1055.4402,23.7095, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 22)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1899.5713,-1070.0177,38.3676,1458.6635,-1030.3673,23.7568, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 23)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1899.3945,-787.7305,45.0793,1383.3145,-1032.3024,26.1900, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 24)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1899.5944,-524.5375,38.3631,1355.6470,-1045.0482,26.4642, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 25)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1899.6989,-211.9125,38.3757,1340.4150,-1127.6436,23.7744, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 26)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1891.1464,33.8305,38.3739,1340.1676,-1379.0829,13.5948, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 27)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1862.9661,243.1431,38.7128,1363.4252,-1405.9730,13.4503, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 28)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1728.9724,476.5461,38.5114,1393.6683,-1430.9860,13.5163, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 29)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1567.5007,640.6575,43.2529,1640.2510,-1443.0830,13.4826, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 30)
					    {
					        ...
					        SetPlayerRaceCheckpoint(playerid, 0, -1315.6837,907.3439,46.3845,1654.4456,-1539.0234,13.4815, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 31)
					    {
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid 100);
				        	AddPlayerSalary(playerid, "Bus Driver(bonus)", 75);
					        BusSteps[playerid][1] = 32;
					        SetPlayerRaceCheckpoint(playerid, 1, -1100.3265,1140.6486,37.5239,1685.5889,-1550.3016,13.4852, 5);
					        return 1;
					    }
					    else if(BusSteps[playerid][1] == 32)
					    {
				    		...
				    		DialogSaya[playerid][1] = false;
							SCM(playerid, ARWIN, "SIDEJOBINFO: {FFFFFF}You have "LG_E"succesfully "WHITE_E"complete bus route lap, and your payment in '"YELLOW_E"/mysalary"WHITE_E"'.");
							AddPlayerSalary(playerid, "Bus Drivers(Los Santos Bank)", 550);
					        pData[playerid][pBusTime] = 1800;
					        DisablePlayerRaceCheckpoint(playerid);
							RemovePlayerFromVehicle(playerid);
							SetTimerEx("RespawnPV", 3000, false, "d", vehicleid);
				...
				if(ForkliftSteps[playerid][i] > 0)
				{
				 	if(IsPlayerInAnyVehicle(playerid))
					{
					    ...
					    else if(ForkliftSteps[playerid][0] == 3)
					    {
					        ...
					        DisablePlayerRaceCheckpoint(playerid);
					        //GivePlayerCash(playerid, 20);
					        AddPlayerSalary(playerid, "Forklift Driver(bonus)", 90);
					    ...
					    else if(ForkliftSteps[playerid][0] == 5)
					    {
					        ...
					        //AddPlayerSala(playerid, "Forklift Driver(bonus)", 1000);
					    ...
					    else if(ForkliftSteps[playerid][0] == 7)
					    {
					        ...
					        AddPlayerSalary(playerid, "Forklift Driver(bonus)", 30);
					    ...
					    else if(ForkliftSteps[playerid][0] == 8)
					    {
					        ...
					        AddPlayerSalary(playerid, "Forklift Driver(bonus)", 10);
					        SetPlayerRaceCheckpoint(playerid, 1, 2425.93, -2486.24, 13.40,1962.7469,-1759.2129,13.3828, 5);
					        return 1;
					    }
					    ...
					    else if(ForkliftSteps[playerid][0] == 15)
					    {
					        ...
					        pData[playerid][pSideJob] = 0;
					        SCM(playerid, ARWIN, "SIDEJOBINFO: {FFFFFF}You have "LG_E"succesfully "WHITE_E"complete street cleanner route, and your payment in '"YELLOW_E"/mysalary"WHITE_E"'.");
							AddPlayerSalary(playerid, "Forklift Drivers", 1250);
		     				pData[playerid][pForTime] = 2250;
			        		DisablePlayerRaceCheckpoint(playerid);
							RemovePlayerFromVehicle(playerid);
							SetTimerEx("RespawnPV", 3000, false, "d", vehicleid);
		     				return 1;
				...
				if(DMVSteps[playerid][i] > 0)
				{
				 	if(IsPlayerInAnyVehicle(playerid))
					{
						if(DMVSteps[playerid][0] == 1)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2047.7871,-95.2380,34.9145, -2065.2163,-116.3382,34.3409, 3);
							return 1;
					    }
					    else if(DMVSteps[playerid][0] == 2)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2065.2163,-116.3382,34.3409, -2065.5105,-139.4374,34.2217, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 3)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2065.5105,-139.4374,34.2217, -2054.6960,-156.9657,34.1954, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 4)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2054.6960,-156.9657,34.1954, -2033.3198,-162.8309,34.2030, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 5)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2033.3198,-162.8309,34.2030, -2032.1241,-190.3489,34.2013, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 6)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2032.1241,-190.3489,34.2013, -2032.2883,-223.9301,34.2012, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 7)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2032.2883,-223.9301,34.2012,  -2032.3694,-256.9078,34.2012, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 8)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2032.3694,-256.9078,34.2012 ,  -2050.6631,-255.9434,34.2027, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 9)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2050.6631,-255.9434,34.2027,  -2046.8016,-237.8254,34.2017, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 10)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2046.8016,-237.8254,34.2017,  -2052.0637,-218.7008,34.2032, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 11)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2052.0637,-218.7008,34.2032, -2049.1296,-203.4507,34.2026, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 12)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2049.1296,-203.4507,34.2026, -2056.6184,-196.3254,34.2030, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 13)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2056.6184,-196.3254,34.2030, -2049.9087,-189.5000,34.2031, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 14)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2049.9087,-189.5000,34.2031, -2056.0300,-181.8765,34.2030, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 15)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2056.0300,-181.8765,34.2030, -2048.9365,-174.1874,34.2023, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 16)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2048.9365,-174.1874,34.2023, -2071.1863,-165.7961,34.2038, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 17)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2071.1863,-165.7961,34.2038, -2081.8538,-175.3412,34.2031, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 18)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2081.8538,-175.3412,34.2031, -2081.7026,-188.6967,36.0995, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 19)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2081.7026,-188.6967,36.0995, -2081.6887,-211.0781,34.2012, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 20)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 0, -2081.6887,-211.0781,34.2012, -2080.9121,-240.8279,34.2026, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 21)
					    {
		    				...
		    				SetPlayerRaceCheckpoint(playerid, 1, -2080.9121,-240.8279,34.2026, -2070.2520,-243.1595,34.2027, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 22)
					    {
							DisablePlayerRaceCheckpoint(playerid);
						    DMVSteps[playerid][0] = 23;
		    				SetPlayerRaceCheckpoint(playerid, 1, -2070.2520,-243.1595,34.2027, -2067.4514,-253.3804,34.2022, 3); //////
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 23)
					    {
							DisablePlayerRaceCheckpoint(playerid);
						    DMVSteps[playerid][0] = 24;
		    				SetPlayerRaceCheckpoint(playerid, 1, -2067.4514,-253.3804,34.2022, -2066.5110,-271.9769,34.2025, 3);
							return 1;
					    }
						else if(DMVSteps[playerid][0] == 24)
					    {
							DisablePlayerRaceCheckpoint(playerid);
						    DMVSteps[playerid][0] = 25;
		    				SetPlayerRaceCheckpoint(playerid, 1, -2066.5110,-271.9769,34.2025,-2066.5110,-271.9769,34.2025, 3);
							return 1;
					    }
					    else if(DMVSteps[playerid][0] == 25)
					    {
					        DMVSteps[playerid][0] = 0;
					        pData[playerid][pBerhasilTest]++;
	...
	if(CheckpointLast[playerid] == 1)
	{
	    if(pData[playerid][pPacket] == 1)
	    {
		    ...
		    taked = 0;
		    packet = 0;
		    new packet_price = Random(4745, 6680);
	...
	if(pData[playerid][pHauling] > -1)
	{
		...
		pData[playerid][pTrailer] = CreateVehicle(584, 322.5988,856.0931,20.63,290.4297, 1, 1, -1);
...
public OnPlayerEnterCheckpoint(playerid)
{
	...
	if(PlayerCheckpoint[playerid] == PIZZA_CHECKPOINT)
	{
	    if(IsPlayerAttachedObjectSlotUsed(playerid,PIZZA_INDEX))
	    {
	        ...
	        {
	            TipTime[playerid]=0;
	            new tip=random(MAX_TIP)+1000;
	            PlayerTips[playerid]+=tip;
   				GivePlayerMoneyEx(playerid, tip);
	            format(string,sizeof(string),"BONUS: "X1_BLUE"Anda juga mendapatkan {7FFF00}$%s {FFFFFF}tip untuk pengiriman cepat!",FormatMoney(tip));
	            SendClientMessage(playerid,COLOR_YELLOW,string);
	            PlayerPlaySound(playerid,1139,0.0,0.0,0.0);
	            HideTipTimeText(playerid);
			}
	    }
	    else return SendClientMessage(playerid, COLOR_YELLOW, "WARNING!. "WHITE_E"Anda harus membawa pizza untuk mengirim ke "X1_BLUE"pembeli{FFFFFF}!");
	}
	...
	foreach(new ii : PVehicles)
	{
		if(vehicleid == pvData[ii][cVeh] && pvData[ii][cRent] == 0 && pvData[ii][cDeath] > gettime())
		{
			if(pvData[ii][cInsu] > 0)
    		{
				...
				pvData[ii][cInsu]--;
				pvData[ii][cClaim] = 1;
				pvData[ii][cClaimTime] = gettime() + (1 * 800);
				foreach(new pid : Player) if (pvData[ii][cOwner] == pData[pid][pID])
        		{
            		Info(pid, "Kendaraan anda hancur dan anda masih memiliki insuransi, silahkan ambil di kantor SAGS");
				}
				if(IsValidVehicle(pvData[ii][cVeh]))
	...
	if(IsValidVehicle(vehicleid))
	{
		...
		if(IsPlayerInAnyVehicle(playerid) && GetPlayerState(playerid) == PLAYER_STATE_DRIVER)
		{
			if(pData[playerid][pHBEMode] == 1)
			{
				...
				{
					PlayerTextDrawSetString(playerid, PlayerSpeedoTD[playerid][2], "~R~OFF");
				}
				else
				{
					PlayerTextDrawSetString(playerid, PlayerSpeedoTD[playerid][2], "~G~ON");
				}
...
ptask PlayerUpdate[999](playerid)
{
	...
	if(A > 100)
	{
		...
		SendClientMessageToAllEx(COLOR_RED, "AUTO BAN: %s was BAN by BOT. Reason: used Armour hacks (%s).", pData[playerid][pName], GetPlayerArmour(pData[playerid][pArmour]));
 		AutoBan(playerid);
		//KickEx(playerid);
	}
	//ANTI CHEAT WEAPON BY OTRP
	if(pData[playerid][pSpawned] == 1)
    {
        if(GetPlayerWeapon(playerid) != pData[playerid][pWeapon])
        {
            ...
            if(pData[playerid][pWeapon] >= 1 && pData[playerid][pWeapon] <= 45 && pData[playerid][pWeapon] != 40 && pData[playerid][pWeapon] != 2 && pData[playerid][pGuns][g_aWeaponSlots[pData[playerid][pWeapon]]] != GetPlayerWeapon(playerid))
            {
                ...
                SendClientMessageToAllEx(COLOR_RED, "AUTO BAN: %s was BAN by BOT. Reason: used weapon hacks (%s).", pData[playerid][pName], ReturnWeaponName(pData[playerid][pWeapon]));
                SetWeapons(playerid); // RESET
               	AutoBan(playerid);
            }
        }
    }
...
public OnPlayerTimer(playerid)
{
	if(pData[playerid][IsLoggedIn] == true)
	{
 	...
 	if(GetPlayerPing(playerid) > 1000) // Ping Player
  	{
   		new fmt_msg[128];
     	format(fmt_msg, sizeof fmt_msg, "BotCmd: %s has been kicked by BOT.", ReturnName(playerid));
      	SendClientMessageToAll(0xFF5533FF, fmt_msg);
       	format(fmt_msg, sizeof fmt_msg, "Reason: High Ping [%d/1000]", GetPlayerPing(playerid));
       	SendClientMessageToAll(0xFF5533FF, fmt_msg);
