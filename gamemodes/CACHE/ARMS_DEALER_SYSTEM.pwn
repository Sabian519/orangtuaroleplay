...
CMD:creategun(playerid, params[])
{
	...
	new Dstring[10000];
	format(Dstring, sizeof(Dstring), "Weapon\tMats & Comps & Price\nSilenced Pistol "RED_E"ammo: 70\t"WHITE_E"500 & 500 / "LG_E2"$90,00\n");
	format(Dstring, sizeof(Dstring), "%sColt45 9MM "RED_E"ammo: 70\t"WHITE_E"500 & 500 / "LG_E2"$70,00\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sDesert Eagle "RED_E"ammo: 70\t"WHITE_E"500 & 500 / "LG_E2"$100,00\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sShotgun "RED_E"ammo: 50\t"WHITE_E"500 & 500 / "LG_E2"$145,00\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sRifle "RED_E"ammo: 35\t"WHITE_E"500 & 500 / "LG_E2"$170,00\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sAK-47 "RED_E"ammo: 150\t"WHITE_E"500 & 500 / "LG_E2"$165,00\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sMicro SMG/Uzi "RED_E"ammo: 200\t"WHITE_E"500 & 500 / "LG_E2"$155,00\n", Dstring);
