...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    if(dialogid == DIALOG_LOGIN)
    {
		...
		if (strcmp(hashed_pass, pData[playerid][pPassword]) == 0)
		{
			...
			SendClientMessage(playerid, -1, "");
			SendClientMessage(playerid, -1, "");
			SendMessage(playerid, "WELCOME:"AQUA"%s "WHITE_E"To this Server "LB_E"OrangTua Roleplay!", pData[playerid][pName]);
			SendMessage(playerid, "NOTE:"AQUA"%s"WHITE_E",Happy Roleplaying, roleplaylah selayaknya di dunia nyata!", pData[playerid][pName]);
			SendMessage(playerid, "NOTE:"WHITE_E"Jangan lupa selalu membaca "RED_E"Rules "WHITE_E"di website kami");
			SendMessage(playerid, "PLAYER:"WHITE_E"It's now "AQUA"%d Online"WHITE_E"in this server", online);
		...
		if(response)
		{
			...
			switch (listitem)
			{
				case 0:
				{
					...
					SendClientMessageEx(playerid,COLOR_WHITE,"discord kami adalah: "YELLOW_E"discord.io/otrp");
					SendClientMessageEx(playerid,COLOR_WHITE,"Selamat bermain di "AQUA"OrangTua Roleplay");
					SendClientMessageEx(playerid,COLOR_PURPLE,"* Anda baru sampai di Los Santos dengan membawa uang $25.00 di saku dan $30.00 di bank");
	...
	if(dialogid == DIALOG_MY_BISNIS)
	{
		...
		ShowPlayerDialog(playerid, BISNIS_INFO, DIALOG_STYLE_LIST, "{FF0000}OT:RP {0000FF}Bisnis", "Show Information\nTrack Bisnis", "Select", "Cancel");
		return 1;
	}
			...
			switch(listitem)
			{
				...
				case 4:
				{
					...
					if(bData[bid][bMoney] < 5000)
						return Error(playerid, "Setidaknya anda mempunyai uang dalam bisnis anda senilai $50,00 untuk merestock product.");
			...
			else if(bData[bizid][bType] == 3)
			{
				switch(listitem)
				{
					...
					case 1:
					{
						...
						ShowPlayerDialog(playerid, DIALOG_TOYBUY, DIALOG_STYLE_LIST, ""RED_E"OT:RP"WHITE_E"Player Toys", string, "Select", "Cancel");
					}
					case 2:
					{
						GivePlayerMoneyEx(playerid, -price);
		...
		if(Player_OwnsBisnis(playerid, pData[playerid][pInBiz]))
		{
			if(response)
			{
				...
				if(strval(inputtext) < 1 || strval(inputtext) > 5000)
				{
					...
					ShowPlayerDialog(playerid, BISNIS_PRICESET, DIALOG_STYLE_INPUT, "Business: Set Product Price", str, "Modify", "Back");
					return 1;
				}
	...
	if(dialogid == DIALOG_BUYPLATE)
	{
		if(response) 
		{
			...
			foreach(new i : PVehicles)
			{
				if(carid == pvData[i][cVeh])
				{
					if(GetPlayerMoney(playerid) < 500) return Error(playerid, "Anda butuh $5,00 untuk membeli Plate baru.");
					GivePlayerMoneyEx(playerid, -500);
					new rand = RandomEx(1111, 9999);
					format(pvData[i][cPlate], 32, "R:RP-%d", rand);
					SetVehicleNumberPlate(pvData[i][cVeh], pvData[i][cPlate]);
					pvData[i][cPlateTime] = gettime() + (15 * 86400);
					Info(playerid, "Model: %s || New plate: %s || Plate Time: %s || Plate Price: $5,00", GetVehicleModelName(pvData[i][cModel]), pvData[i][cPlate], ReturnTimelapse(gettime(), pvData[i][cPlateTime]));
				}
			}
		}
		return 1;
		...
		if(response)
		{
			switch(listitem)
			{
				...
				case 2: // change bone
				{
					...
					ShowPlayerDialog(playerid, DIALOG_TOYPOSISI, DIALOG_STYLE_LIST, ""RED_E"OrangTua : "WHITE_E"Player Toys", finstring, "Select", "Cancel");
				}
				case 3:
				{
		...
		if(response)
		{
			switch(listitem)
			{
				...
				case 0:
				{
					...
					strcat(S3MP4K, str);
					format(str, sizeof(str), "Copyright(s) OrangTua Roleplay Job Taxi Help 2021\n", str);
					strcat(S3MP4K, str);
				...
				case 1:
				{
					...
					strcat(S3MP4K, str);
					format(str, sizeof(str), "Copyright(s) OrangTua Roleplay Job Mechanic Jobs Help 2021\n", str);
					strcat(S3MP4K, str);
				...
				case 2:
				{
					...
					strcat(S3MP4K, str);
					format(str, sizeof(str), "Copyright(s) OrangTua Roleplay Lumberjack Jobs Help 2021\n", str);
					strcat(S3MP4K, str);
				...
				case 7:
				{
					...
					strcat(S3MP4K, str);
					format(str, sizeof(str), "Copyright(s) OrangTua Job Depositor Help 2021\n", str);
					strcat(S3MP4K, str);
		...
		if(response)
		{
			switch(listitem)
			{
				...
				case 17:
				{
					...
					strcat(location,lstr,sizeof(location));
					format(lstr,sizeof(lstr), "Miner Jobs\t"YELLOW_E"%0.2fm\n", GetPlayerDistanceFromPoint(playerid, -1919.6445,-1713.1741,21.7500));
					strcat(location,lstr,sizeof(location));
	...
	if(dialogid == DIALOG_GPS_JOB)
	{
		if(response)
		{
			switch(listitem)
			{
				...
				case 4:
				{
					SetPlayerRaceCheckpoint(playerid,1, -1919.6445,-1713.1741,21.7500, 0.0, 0.0, 0.0, 3.5); //Miner
		...
		if(response)
		{
			switch(listitem)
			{
				case 0: //slc pistol
				{
					...
					if(GetPlayerMoney(playerid) < 9000) return Error(playerid, "Not enough money!");
					...
					Info(playerid, "Anda membuat senjata ilegal dengan 500 material dan 500 component dengan harga "LG_E"$90,00!");
				...
				case 1: //colt45 9mm
				{
					...
					if(pData[playerid][pMaterial] < 500) return Error(playerid, "Material tidak cukup!(Butuh: 500).");
					if(pData[playerid][pComponent] < 500) return Error(playerid, "Component tidak cukup!(Butuh: 500).");
					if(GetPlayerMoney(playerid) < 7000) return Error(playerid, "Not enough money!");
					...
					TogglePlayerControllable(playerid, 0);
					Info(playerid, "Anda membuat senjata ilegal dengan 500 material dan 500 component dengan harga "LG_E"$70,00!");
					ApplyAnimation(playerid, "BD_FIRE", "wash_up", 4.1, 0, 0, 0, 0, 0, 1);
				...
				case 2: //deagle
				{
					...
					TogglePlayerControllable(playerid, 0);
					Info(playerid, "Anda membuat senjata ilegal dengan 500 material dan 500 component dengan harga "LG_E"$100,00!");
					ApplyAnimation(playerid, "BD_FIRE", "wash_up", 4.1, 0, 0, 0, 0, 0, 1);
				...
				case 3: //shotgun
				{
					...
					if(pData[playerid][pMaterial] < 500) return Error(playerid, "Material tidak cukup!(Butuh: 500).");
					if(pData[playerid][pComponent] < 500) return Error(playerid, "Component tidak cukup!(Butuh: 500).");
					if(GetPlayerMoney(playerid) < 14500) return Error(playerid, "Not enough money!");

					pData[playerid][pMaterial] -= 500;
					pData[playerid][pComponent] -= 500;
					GivePlayerMoneyEx(playerid, -14500);

					TogglePlayerControllable(playerid, 0);
					Info(playerid, "Anda membuat senjata ilegal dengan 500 material dan 500 component dengan harga"LG_E" $145,00!");
					ApplyAnimation(playerid, "BD_FIRE", "wash_up", 4.1, 0, 0, 0, 0, 0, 1);
				...
				case 4: //rifle
				{
					...
					if(pData[playerid][pMaterial] < 500) return Error(playerid, "Material tidak cukup!(Butuh: 500).");
					if(pData[playerid][pComponent] < 500) return Error(playerid, "Component tidak cukup!(Butuh: 500).");
					if(GetPlayerMoney(playerid) < 17000) return Error(playerid, "Not enough money!");

					pData[playerid][pMaterial] -= 500;
					pData[playerid][pComponent] -= 500;
					GivePlayerMoneyEx(playerid, -17000);

					TogglePlayerControllable(playerid, 0);
					Info(playerid, "Anda membuat senjata ilegal dengan 500 material dan 500 component dengan harga "LG_E"$170,00!");
					ApplyAnimation(playerid, "BD_FIRE", "wash_up", 4.1, 0, 0, 0, 0, 0, 1);
				...
				case 5: //ak-47
				{
					...
					if(pData[playerid][pMaterial] < 500) return Error(playerid, "Material tidak cukup!(Butuh: 500).");
					if(pData[playerid][pComponent] < 500) return Error(playerid, "Component tidak cukup!(Butuh: 500).");
					if(GetPlayerMoney(playerid) < 16500) return Error(playerid, "Not enough money!");

					pData[playerid][pMaterial] -= 500;
					pData[playerid][pComponent] -= 500;
					GivePlayerMoneyEx(playerid, -16500);

					TogglePlayerControllable(playerid, 0);
					Info(playerid, "Anda membuat senjata ilegal dengan 500 material dan 500 component dengan harga "LG_E"$165,00!");
					ApplyAnimation(playerid, "BD_FIRE", "wash_up", 4.1, 0, 0, 0, 0, 0, 1);
					pData[playerid][pArmsDealer] = SetTimerEx("CreateGun", 1000, true, "idd", playerid, WEAPON_AK47, 150);
					PlayerTextDrawSetString(playerid, ActiveTD[playerid], "Creating...");
					PlayerTextDrawShow(playerid, ActiveTD[playerid]);
					ShowPlayerProgressBar(playerid, pData[playerid][activitybar]);
				}
				case 6: //Micro smg uzi
				{
					...
					if(pData[playerid][pMaterial] < 500) return Error(playerid, "Material tidak cukup!(Butuh: 500).");
					if(pData[playerid][pComponent] < 500) return Error(playerid, "Component tidak cukup!(Butuh: 500).");
					if(GetPlayerMoney(playerid) < 15500) return Error(playerid, "Not enough money!");

					pData[playerid][pMaterial] -= 500;
					pData[playerid][pComponent] -= 500;
					GivePlayerMoneyEx(playerid, -15500);

					TogglePlayerControllable(playerid, 0);
					Info(playerid, "Anda membuat senjata ilegal dengan 500 material dan 500 component dengan harga "LG_E"$155,00!");
					ApplyAnimation(playerid, "BD_FIRE", "wash_up", 4.1, 0, 0, 0, 0, 0, 1);
    ...
    if(dialogid == DIALOG_DEALER_RESTOCK)
	{
		if(response)
		{
			...
			if(DealerData[id][dealerMoney] < 57500)
				return Error(playerid, "Dealer harus memiliki minimal uang "LG_E"$575,00 "GREY_E"untuk bayaran restock trucker.");
	...
	if(dialogid == DIALOG_GASOIL)
	{
		if(response)
		{
			...
			if(total > 1000) return Error(playerid, "Gas Oil Maximal 1.000 liter in your vehicle tank!");
			GivePlayerMoneyEx(playerid, -value);
		...
		if(response)
		{
			switch(listitem)
			{
				...
				case 2:
				{
					...
					GivePlayerMoneyEx(playerid, -300);
					Server_AddMoney(100);
					Info(playerid, "Anda membeli bandage seharga "LG_E2"$03,00");
				}
			}
		}
	}
	if(dialogid == DIALOG_ATM)
	{
		...
		switch(listitem)
		{
			...
			case 1: // Withdraw
			{
				...
				ShowPlayerDialog(playerid, DIALOG_ATMWITHDRAW, DIALOG_STYLE_LIST, mstr, "$05,00\n$10,00\n$50,00\n$100,00\n$500,00", "Withdraw", "Cancel");
			}
		...
		if(response)
		{
			switch(listitem)
			{
				case 0:
				{
					...
					Info(playerid, "ATM withdraw "LG_E"$05,00");
				}
				case 1:
				{
					...
					Info(playerid, "ATM withdraw "LG_E"$10,00");
				}
				case 2:
				{
				...
				case 3:
				{
					if(pData[playerid][pBankMoney] < 10000)
						return Error(playerid, "Not enough balance!");
					
					GivePlayerMoneyEx(playerid, 10000);
					pData[playerid][pBankMoney] -= 10000;
					Info(playerid, "ATM withdraw "LG_E"$100,00");
				}
				case 4:
				{
			...
			if(GetPlayerMoney(playerid) >= 5000)
			{
				if(listitem == 0)
				{
    				...
    				if(pData[playerid][pGymVip] >= 1)
				    {
        				...
        				SendClientMessageEx(playerid, COLOR_YELLOW, "GYM MEMBERSHIP:"WHITE_E" You have received 20 percent off this product. Instead of paying $50000, you paid $40000.");
					}
					else
					{
