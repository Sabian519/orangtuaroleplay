...
CMD:sellfish(playerid, params[]) //2844.03, -1516.75, 11.29
{
	if(!IsPlayerInRangeOfPoint(playerid, 3.0, -2158.1750,649.7681,52.3672)) return Error(playerid, "You're not nearest in Fish Factory.");
