...
CreateServerPoint()
{
	...
	//JOBS
	MatPickup = CreateDynamicPickup(1239, 23, -2184.5906,-209.5870,36.5156, -1, -1, -1, 5.0);
	format(strings, sizeof(strings), "[Material]\n"WHITE_E"Material Stock: "LG_E"%d\n\n"WHITE_E"Material Price: "LG_E"%s"WHITE_E"/item\n"YELLOW_E"/buy"WHITE_E"' to buy material\n"YELLOW_E"/sellcrate"WHITE_E"' to sealed material crates", Material, FormatMoney(MaterialPrice));
	MatText = CreateDynamic3DTextLabel(strings, ARWIN, -2184.5906,-209.5870,36.5156, 5.0); // Producrion
	
	CompPickup = CreateDynamicPickup(1239, 23, -1819.4456,-151.3634,9.3984, -1, -1, -1, 5.0);
	...
	CompText = CreateDynamic3DTextLabel(strings, COLOR_YELLOW, -1819.4456,-151.3634,9.3984, 5.0); // comp
	...
	ApotekPickup = CreateDynamicPickup(1448.85, -32.467, 1000.92, -1, -1, -1, 5.0);
	format(strings, sizeof(strings), "[Hospital]\n"WHITE_E"Apotek Stock: "LG_E"%d\n"LB_E"/buy", Apotek);
	ApotekText = CreateDynamic3DTextLabel(strings, COLOR_PINK, 1448.85, -32.467, 1000.92, 5.0); // Apotek hospital
	...
	SellFishPickup = CreateDynamicPickup(1599, 23, -2158.1750,649.7681,52.3672, -1, -1, -1, 25.0);
	...
	SellFishText = CreateDynamic3DTextLabel(strings, COLOR_GREY, -2158.1750,649.7681,52.3672, 25.0); // product

	CrateFishPickup = CreateDynamicPickup(2912, 23, -2173.0813,632.2081,49.4375, -1, -1, -1, 25.0);
	...
	CrateFishText = CreateDynamic3DTextLabel(strings, ARWIN, -2173.0813,632.2081,49.4375, 25.0); // product

	CrateCompPickup = CreateDynamicPickup(2912, 23, -1919.6656,-1702.8213,22.2700, -1, -1, -1, 25.0);
	...
	CrateCompText = CreateDynamic3DTextLabel(strings, ARWIN, -1919.6656,-1702.8213,22.2700, 25.0); // comp

	CrateComponentStockPickup = CreateDynamicPickup(2912, 23, -1883.4598,-201.1821,16.0468, -1, -1, -1, 25.0);
	format(strings, sizeof(strings), "[Component Restock]\n"WHITE_E"use command '"YELLOW_E"/sellcrate"WHITE_E"' to store crates component");
	CrateComponentStockText = CreateDynamic3DTextLabel(strings, ARWIN, -1883.4598,-201.1821,16.0468, 25.0); // comp

	CrateMaterialPickup = CreateDynamicPickup(2912, 23, -1053.0963,-664.1098,32.0126, -1, -1, -1, 25.0);
	format(strings, sizeof(strings), "[Material Crates]\n"WHITE_E"Available Stock: "LG_E"%d\n"YELLOW_E"/getcrate"WHITE_E"' to pickup crate\n"YELLOW_E"/lum sell"WHITE_E"' to sealed lumber", CrateMaterial);
	CrateMaterialText = CreateDynamic3DTextLabel(strings, ARWIN, -1053.0963,-664.1098,32.0126, 25.0); // lumber
