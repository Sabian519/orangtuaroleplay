	...
	if(IsPlayerInAnyVehicle(playerid) && GetPlayerState(playerid) == PLAYER_STATE_DRIVER)
	{
		...
		foreach(new i: PVehicles)
		{
			if(x == pvData[i][cVeh])
			{
				...
				ShowPlayerDialog(playerid, DIALOG_VTOYBUY, DIALOG_STYLE_LIST, ""RED_E"Luxury -RP: "WHITE_E"Vehicle Toys", string, "Select", "Cancel");
			}
		}
	}
	...
	if(IsPlayerInRangeOfPoint(playerid, 5.0, ModsPoint[aaa][ModsPos][0], ModsPoint[aaa][ModsPos][1], ModsPoint[aaa][ModsPos][2]))
	{
		if(IsPlayerInAnyVehicle(playerid) && GetPlayerState(playerid) == PLAYER_STATE_DRIVER)
		{
			...
			if(x == pvData[i][cVeh])
			{
				...
				ShowPlayerDialog(playerid, DIALOG_VTOY, DIALOG_STYLE_LIST, ""RED_E"Luxury -RP: "WHITE_E"My object vehicle", string, "Select", "Cancel");
			}
		}
		else return Error(playerid, "Anda harus mengendarai kendaraan!");
	}
			...
			switch(listitem)
			{
				case 0: //slot 1
				{
					...
					else
					{
						...
						ShowPlayerDialog(playerid, DIALOG_VTOYEDIT, DIALOG_STYLE_LIST, ""RED_E"Luxury RP: "WHITE_E"Object Vehicle", string, "Select", "Cancel");
					}
				}
				case 1: //slot 2
				{
		...
		if(response)
		{
			switch(listitem)
			{
				case 0: //slot 1
				{
					...
					{
						ShowPlayerDialog(playerid, DIALOG_VTOYEDIT, DIALOG_STYLE_LIST, ""RED_E"Luxury -RP: "WHITE_E"Vehicle Object", ""dot"Edit Toy Position\n"dot""GREY_E"Remove Toy", "Select", "Cancel");
					}
				}
				case 1: //slot 2
				{
					...
					{
						ShowPlayerDialog(playerid, DIALOG_VTOYEDIT, DIALOG_STYLE_LIST, ""RED_E"Luxury -RP "WHITE_E"Vehicle Toys", ""dot"Edit Toy Position\n"dot""GREY_E"Remove Toy", "Select", "Cancel");
					}
				}
				case 2: //slot 3
				{
